...
class PhotosAlbumsController extends MeCmsAppController {
	...
	public function admin_delete($id = NULL) {
		...
		if(!$this->PhotosAlbum->field('photo_count')) {
			...
			$this->Session->flash(__d('me_cms', 'Before you delete this album, you have to delete its photos or assign them to another album'), 'alert');
	...
	public function admin_index() {
		$this->paginate = array(
			...
			'order'		=> array('PhotosAlbum.title' => 'ASC')
		);
