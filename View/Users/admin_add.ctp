...
<div class="users form">
	<?php echo $this->Html->h2(__d('me_cms_backend', 'Add user')); ?>
		...
		<div class='float-form'>
			<?php
				...
				echo $this->Form->input('active', array(
					'checked'	=> TRUE,
					'tip'		=> __d('me_cms_backend', 'If is not active, the user won\'t be able to login')
				));
			?>
		</div>
		<fieldset>
	...
	<?php echo $this->Form->end(__d('me_cms_backend', 'Add user')); ?>
</div>