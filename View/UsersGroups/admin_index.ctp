				...
				<td>
					<?php
						...
						echo $this->Html->ul(array(
							...
							$this->Form->postLink(__d('me_cms', 'Delete'), array('action' => 'delete', $id), array('class' => 'text-danger', 'icon' => 'trash-o'), __d('me_cms', 'Are you sure you want to delete this users group?'))
						), array('class' => 'actions'));
					?>
				</td>
