 ...
 * @package		MeCmsBackend\View\UsersGroups
 */
?>
...
<div class="usersGroups form">
	<?php echo $this->Html->h2(__d('me_cms_backend', 'Add users group')); ?>
	...
	<?php echo $this->Form->end(__d('me_cms_backend', 'Add users group')); ?>
</div>