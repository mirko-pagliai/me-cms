...
<div class="posts form">
	<?php echo $this->Html->h2(__d('me_cms_backend', 'Edit post')); ?>
	<?php echo $this->Form->create('Post', array('class' => 'form-base')); ?>
		<div class='float-form'>
			<?php
				echo $this->Form->input('user_id', array('label' => __d('me_cms_backend', 'Author')));
	...
	<?php echo $this->Form->end(__d('me_cms_backend', 'Edit post')); ?>
</div>