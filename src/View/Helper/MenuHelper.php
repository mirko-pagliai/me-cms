...
class MenuHelper extends Helper
{
    ...
    public function posts()
    {
        $menu = [
            $this->Html->link(
                __d('me_cms', 'List posts'),
                ['controller' => 'Posts', 'action' => 'index', 'plugin' => MECMS]
            ),
            $this->Html->link(
                __d('me_cms', 'Add post'),
                ['controller' => 'Posts', 'action' => 'add', 'plugin' => MECMS]
            ),
        ];
