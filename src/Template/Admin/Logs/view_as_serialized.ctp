        ...
        <?php foreach ($content as $k => $row) : ?>
            ...
            if (!empty($row->attributes)) {
                ...
                $collapse[] = $this->Html->div(
                    'collapse',
                    $this->Html->pre($row->attributes, ['class' => 'pre-scrollable small mb-2']),
                    ['id' => "log-attributes-{$k}"]
                );
            }
            ...
            if (!empty($row->trace)) {
                ...
                $collapse[] = $this->Html->div(
                    'collapse',
                    $this->Html->pre($row->trace, ['class' => 'pre-scrollable small mb-2']),
                    ['id' => "log-trace-{$k}"]
                );
            }
            ...
            $collapse[] = $this->Html->div(
                'collapse',
                $this->Html->pre($row->full, ['class' => 'pre-scrollable small mb-2']),
                ['id' => "log-full-{$k}"]
            );
